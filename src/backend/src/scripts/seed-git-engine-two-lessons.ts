...
async function seedTwoLessons() {
  ...
  try {
    ...
    const practice1 = dataSource.getRepository(Practice).create({
      ...
      scenario:
        'Start a repository, check status, and create the first commit.',
      difficulty: 1,
      estimatedTime: 10,
      isActive: true,
      order: 1,
    ...
    await dataSource.getRepository(PracticeInstruction).save([
      ...
      {
        practiceId: savedPractice1.id,
        content: 'Create the initial commit',
        order: 3,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ...
    await dataSource.getRepository(PracticeHint).save([
      ...
      {
        practiceId: savedPractice1.id,
        content: 'Commit with git commit -m "Initial commit"',
        order: 3,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ...
    await dataSource.getRepository(PracticeValidationRule).save([
      {
        ...
        value: '3',
        message: 'Execute at least 3 commands',
        order: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        value: 'git init,git status,git commit',
        message: 'Use init, status, commit',
        order: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ...
    const lesson2 = dataSource.getRepository(Lesson).create({
      ...
      description:
        'Work with branches using branch, checkout, switch, and clear.',
    ...
    await dataSource.getRepository(PracticeInstruction).save([
      {
        ...
        content: 'Initialize repository and make initial commit',
        order: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        practiceId: savedPractice2.id,
        content: 'Create feature/login branch',
        order: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        practiceId: savedPractice2.id,
        content: 'Switch to feature/login and commit a change',
        order: 3,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ...
    await dataSource.getRepository(PracticeHint).save([
      {
        practiceId: savedPractice2.id,
        content: 'Use git branch feature/login',
        order: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        practiceId: savedPractice2.id,
        content:
          'Switch with git checkout feature/login or git switch feature/login',
        order: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        practiceId: savedPractice2.id,
        content: 'Use git commit -m "message"',
        order: 3,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ...
    await dataSource.getRepository(PracticeValidationRule).save([
      {
        ...
        type: ValidationRuleType.MIN_COMMANDS,
        value: '5',
        message: 'Execute at least 5 commands',
        order: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        practiceId: savedPractice2.id,
        type: ValidationRuleType.REQUIRED_COMMANDS,
        value: 'git init,git commit,git branch,git checkout,git switch',
        message: 'Use init/commit/branch/checkout/switch',
        order: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
