...
4. Communicate with team members`,
    ...
    const savedLessons = await dataSource
      .getRepository(Lesson)
      .save([lesson1, lesson2, lesson3]);
    ...
    const practice1 = dataSource.getRepository(Practice).create({
      ...
      scenario:
        'You are starting a new project and need to set up version control. Create a new Git repository and make your first commit.',
      difficulty: 1,
      estimatedTime: 10,
      isActive: true,
      order: 1,
    ...
    const savedPractice1 = await dataSource
    ...
    const practice2 = dataSource.getRepository(Practice).create({
      ...
      scenario:
        'You have multiple files in your project. Learn how to stage specific files and understand the difference between working directory, staging area, and repository.',
      difficulty: 2,
      estimatedTime: 15,
      isActive: true,
      order: 2,
    ...
    const savedPractice2 = await dataSource
      .getRepository(Practice)
      .save(practice2);
    ...
    const practice3 = dataSource.getRepository(Practice).create({
      ...
      scenario:
        'You need to work on a new feature without affecting the main branch. Create a new branch and switch to it.',
      difficulty: 2,
      estimatedTime: 12,
      isActive: true,
      order: 1,
    ...
    const savedPractice3 = await dataSource
      .getRepository(Practice)
      .save(practice3);
    ...
    const practice4 = dataSource.getRepository(Practice).create({
      ...
      scenario:
        'You have completed your feature branch and want to merge it back to the main branch.',
      difficulty: 3,
      estimatedTime: 20,
      isActive: true,
      order: 2,
    ...
    const savedPractice4 = await dataSource
      .getRepository(Practice)
      .save(practice4);
    ...
    const practice5 = dataSource.getRepository(Practice).create({
      ...
      scenario:
        'You want to contribute to an open source project. Clone the repository, make changes, and prepare for contribution.',
      difficulty: 3,
      estimatedTime: 25,
      isActive: true,
      order: 1,
    ...
    const savedPractice5 = await dataSource
      .getRepository(Practice)
      .save(practice5);
