...
import {
  ...
  ValidationRuleType,
} from '../entities/practice-validation-rule.entity';
...
export class PracticeValidationRuleService {
  ...
  async createValidationRules(
    ...
    const ruleRepo = queryRunner
      ? queryRunner.manager.getRepository(PracticeValidationRule)
      : this.validationRuleRepository;
