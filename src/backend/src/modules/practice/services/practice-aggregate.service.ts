...
export class PracticeAggregateService implements IPracticeService {
  ...
  async createPractice(
    ...
    try {
      ...
      const savedPractice = await this.practiceEntityService.create(
        createPracticeDTO,
        queryRunner,
      );
  ...
  async updatePractice(
    ...
    try {
      ...
      const practice = await this.practiceEntityService.findById(
        id,
        queryRunner,
      );
      if (!practice) {
      ...
      await this.practiceEntityService.update(
        id,
        updatePracticeDTO,
        queryRunner,
      );
  ...
  private async createRelatedEntities(
    ...
    if (dto.instructions?.length) {
      promises.push(
        this.practiceInstructionService.createInstructions(
          practiceId,
          dto.instructions,
          queryRunner,
        ),
    ...
    if (dto.hints?.length) {
      promises.push(
        this.practiceHintService.createHints(
          practiceId,
          dto.hints,
          queryRunner,
        ),
    ...
    if (dto.expectedCommands?.length) {
      promises.push(
        this.practiceExpectedCommandService.createExpectedCommands(
          practiceId,
          dto.expectedCommands,
          queryRunner,
        ),
      );
    }
    ...
    if (dto.validationRules?.length) {
      promises.push(
        this.practiceValidationRuleService.createValidationRules(
          practiceId,
          dto.validationRules,
          queryRunner,
        ),
    ...
    if (dto.tags?.length) {
      promises.push(
        this.practiceTagService.createTags(practiceId, dto.tags, queryRunner),
      );
    }
  ...
  private async updateRelatedEntities(
    ...
    if (dto.instructions !== undefined) {
      promises.push(
        this.practiceInstructionService.updateInstructions(
          practiceId,
          dto.instructions,
          queryRunner,
        ),
    ...
    if (dto.hints !== undefined) {
      promises.push(
        this.practiceHintService.updateHints(
          practiceId,
          dto.hints,
          queryRunner,
        ),
    ...
    if (dto.expectedCommands !== undefined) {
      promises.push(
        this.practiceExpectedCommandService.updateExpectedCommands(
          practiceId,
          dto.expectedCommands,
          queryRunner,
        ),
    ...
    if (dto.validationRules !== undefined) {
      promises.push(
        this.practiceValidationRuleService.updateValidationRules(
          practiceId,
          dto.validationRules,
          queryRunner,
        ),
    ...
    if (dto.tags !== undefined) {
      promises.push(
        this.practiceTagService.updateTags(practiceId, dto.tags, queryRunner),
      );
    }
  ...
  private buildQueryBuilder(
    ...
    if (difficulty) {
      queryBuilder.andWhere('practice.difficulty = :difficulty', {
        difficulty,
      });
    }
    ...
    if (publishedOnly !== false) {
      queryBuilder.andWhere('lesson.status = :publishedStatus', {
