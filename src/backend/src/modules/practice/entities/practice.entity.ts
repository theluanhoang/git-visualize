...
export class Practice extends CommonEntity {
  ...
  // Relations
  @OneToMany(() => PracticeInstruction, (instruction) => instruction.practice, {
    cascade: true,
  })
  ...
  @OneToMany(() => PracticeExpectedCommand, (command) => command.practice, {
    cascade: true,
  })
  expectedCommands: PracticeExpectedCommand[];

  @OneToMany(() => PracticeValidationRule, (rule) => rule.practice, {
    cascade: true,
  })
